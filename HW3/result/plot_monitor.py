...
burn = 10000
monitor1 = np.genfromtxt('monitor1.txt')
monitor2 = np.genfromtxt('monitor2.txt')
monitor3 = np.genfromtxt('monitor3.txt')
monitor4 = np.genfromtxt('monitor3_2.txt')
monitor5 = np.genfromtxt('monitor4_2.txt')
...
plt.ylabel('Action')
plt.grid(True)
plt.savefig('plot_monitor4.png', dpi=100)
plt.figure(6)
