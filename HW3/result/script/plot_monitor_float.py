...
plt.savefig('plot_monitor1f_latex.png', dpi=300)
plt.figure(2)
...
plt.savefig('plot_monitor2f_latex.png', dpi=300)
plt.figure(3)
...
plt.savefig('plot_monitor3f_latex.png', dpi=300)
plt.figure(4)
...
plt.savefig('plot_monitor3f_2_latex.png', dpi=300)
plt.figure(5)
...
plt.savefig('plot_distf_latex.png', dpi=300)
plt.figure(7)
plt.hist(converged_dist4, bins = 1000, label=r'$n_f=3$, setup: 2')
plt.hist(converged_dist5, bins = 1000, label=r'$n_f=4$, setup: 2')
plt.xlabel('Action')
...
plt.savefig('plot_dist2f_latex.png', dpi=300)