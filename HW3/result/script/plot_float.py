...
r = np.genfromtxt('zeta1f.txt')
r2 = np.genfromtxt('zeta2f.txt')
r3 = np.genfromtxt('zeta3f.txt')
r4 = np.genfromtxt('zeta3f_2.txt')
r5 = np.genfromtxt('zeta4f_2.txt')
r6 = np.genfromtxt('zeta6f_b.txt')
...
plt.savefig('plot_traj_float.png', dpi=100)
plt.savefig('plot_traj_float.eps', dpi=300)
...
plt.xlim(0.0, 3.2)
plt.legend(loc='upper right')
plt.savefig('plot_zeta_float.png', dpi=100)
plt.savefig('plot_zeta_float.eps', dpi=300)
...
plt.xlim(0.0, 3.2)
plt.legend(loc='upper right')
plt.savefig('plot_theta_float.png', dpi=100)
plt.savefig('plot_theta_float.eps', dpi=300)
...
plt.xlim(-1.175, 0.95)
plt.legend(loc='upper right')
plt.savefig('plot_traj_bezier_float.png', dpi=100)
plt.savefig('plot_traj_bezier_float.eps', dpi=300)
...
plt.xlim(0.0, 3.2)
plt.legend(loc='upper right')
plt.savefig('plot_zeta_bezier_float.png', dpi=100)
plt.savefig('plot_zeta_bezier_float.eps', dpi=300)
...
plt.xlim(0.0, 3.2)
plt.legend(loc='upper right')
plt.savefig('plot_theta_bezier_float.png', dpi=100)
plt.savefig('plot_theta_bezier_float.eps', dpi=300)