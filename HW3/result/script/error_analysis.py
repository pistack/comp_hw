...
l_2_error_1f = np.sqrt(simpson(error1f, t))
l_2_error_2f = np.sqrt(simpson(error2f, t))
l_2_error_3f = np.sqrt(simpson(error3f, t))
l_2_error_3f_2 = np.sqrt(simpson(error3f_2, t))
l_2_error_4f_2 = np.sqrt(simpson(error4f_2, t))
