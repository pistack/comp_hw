...
plt.figure(1)
plt.plot(r[:, 1]*np.cos(r[:, 2]), r[:, 1]*np.sin(r[:, 2]), marker='o', markersize=3, label='HW3')
...
plt.figure(2)
plt.plot(r[:, 0], r[:, 1], marker='o', markersize=3, label='HW3')
...
plt.figure(3)
plt.plot(r[:, 0], r[:, 2], marker='o', markersize=3, label='HW3')
